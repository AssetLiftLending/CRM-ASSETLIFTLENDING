  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div>
        ...
        <p className="text-gray-500 text-sm">Create platform admins, organization admins, staff, brokers, and borrowers.</p>
      </div>

      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4">
        <div>
          <h2 className="font-bold text-dark-800">Create User</h2>
          <p className="text-xs text-gray-500 mt-1">Borrower users are linked to a contact so they can log in and upload documents.</p>
        </div>
